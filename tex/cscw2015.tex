...
[removed for blind review]} In selecting which
...
\includegraphics[scale=0.4]{figures/aprr_up_ggplot.png} \caption{User
...
\begin{figure}[p] \centering
\includegraphics[scale=0.4]{figures/aprr_up_repeaters_ggplot.png} \caption{User
...
\begin{figure}[p] \centering
\includegraphics[scale=0.4]{figures/aprr_up_repeaters_10_ggplot.png}
...
\begin{figure}[p] \centering
\includegraphics[scale=0.4]{figures/commented_pullrequests_totals_ggplot.png}
...
process~\cite{bird_open_2007, goeminne_comparison_2013, kouters_whos_2012}.
