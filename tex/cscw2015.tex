...
Table~\ref{tbl:variables} summarizes the variables we used.

\begin{table*}[ht]
\centering
\begin{tabular}{p{10em} r @{.} l  r @{.} l }
\hline
\textbf{Predictor} & \multicolumn{2}{c}{\textbf{Model 1}} & \multicolumn{2}{c}{\textbf{Model 2}}\\ \hline
\multicolumn{5}{l}{Developer Engagement}\\
 \-\hspace{1em}Pull request comments & -0&16 & -1&26*** \\
 & 0&15 & -0&20 \\
\-\hspace{1em}Issue comments & -0&16 & -1&26*** \\
 & 0&15 & -0&20 \\
\-\hspace{1em}Issues opened & -0&16 & -1&26*** \\
 & 0&15 & -0&20 \\ \hline
\multicolumn{5}{l}{Community Response}\\
 \-\hspace{1em}Pull request comments & -0&16 & -1&26*** \\
 & 0&15 & -0&20 \\ \hline
\multicolumn{5}{l}{Controls}\\
 \-\hspace{1em}Dev reputation & -0&16 & -1&26*** \\
 & 0&15 & -0&20 \\
 \-\hspace{1em}Repo changes & -0&16 & -1&26*** \\
 & 0&15 & -0&20 \\
 \-\hspace{1em}Repo contributors & -0&16 & -1&26*** \\
 & 0&15 & -0&20 \\ \hline
\multicolumn{5}{p{20em}}{\textit{Note: Predictors' significance are indicated with asterisk
where *, **, *** represent p \textless 0.1, p \textless 0.05, p \textless 0.001, respectively.}} \\
\hline
\end{tabular}
\caption{Logistic Regression Results: Predicting whether a pull request will be merged}  
\label{tab:logit_reg}
\end{table*} 
